...
Proyek utama dalam pembelajaran ini menggunakan pendekatan *project-based learning* (pembelajaran berbasis proyek) dengan membangun dan merekonstruksi **Website Profil Pondok Pesantren Minhajul Haq**.
...
5. **Validasi Formulir**: Validasi input formulir kontak secara *client-side* menggunakan **Regular Expression (RegEx)**.
...
├── hero.png                  # Aset gambar utama website
...
*Detail penjelasan materi dan instruksi tugas mandiri dapat dibaca secara lengkap di berkas [Modul_HTML_CSS_JS.md](file:///c:/Users/irfan/OneDrive/Documents/STAI-2026-2027/Modul%20IT/HTML_Basic/Modul_HTML_CSS_JS.md).*
...
4. Setiap kali Anda melakukan perubahan kode pada file HTML, CSS, atau JS, halaman browser akan otomatis memuat ulang (*auto-reload*).
